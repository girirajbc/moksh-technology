...
(function ($) {
	...
	function initializeMobileMenu() {
		$('#mobile-menu').meanmenu({
			meanMenuContainer: '.mobile-menu', // Ensure this targets the container inside the sidebar
			meanScreenWidth: "991",
	...
	// Function to attach sidebar event listeners
	...
	// Load sidebar dynamically and attach listeners
	document.addEventListener("DOMContentLoaded", function () {
		fetch('sidebar.html')
			.then(response => response.text())
			.then(data => {
				document.getElementById('sidebar').innerHTML = data;
				// Call function to attach listeners and initialize the mobile menu after content is loaded
				attachSidebarListeners();
				initializeMobileMenu(); // Initialize the mobile menu inside the sidebar
			})
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Find the span with id 'currentYear' and set its text content to the current year
